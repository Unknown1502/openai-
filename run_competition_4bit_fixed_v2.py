#!/usr/bin/env python3
"""Run competition with proper 4-bit quantization support using BitsAndBytesConfig"""
...
class QuantizedModelClient:
    """Client for 4-bit quantized model with proper BitsAndBytesConfig support"""
    ...
    def start(self):
        """Load model with 4-bit quantization using BitsAndBytesConfig"""
        ...
        # Load with proper quantization config
        ...
        if torch.cuda.is_available():
            ...
            print(f"Model memory footprint: ~{self._model.get_memory_footprint() / 1e9:.2f} GB")
    ...
    def generate(self, prompt, **kwargs):
        ...
        # Get device from model (don't manually move to cuda)
...
def main():
    ...
    print("🎯 Starting OpenAI GPT-OSS-20B Red-Teaming (4-bit quantization mode)...")
